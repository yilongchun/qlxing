...
#pragma clang diagnostic pop
    ...
    if ([indicator isKindOfClass:[UIActivityIndicatorView class]]) {
        UIActivityIndicatorView *appearance = [UIActivityIndicatorView appearanceWhenContainedInInstancesOfClasses:[NSArray arrayWithObject:[MBProgressHUD class]]];
        if (appearance.color == nil) {
            ((UIActivityIndicatorView *)indicator).color = color;
        }
    } else if ([indicator isKindOfClass:[MBRoundProgressView class]]) {
        MBRoundProgressView *appearance = [MBRoundProgressView appearanceWhenContainedInInstancesOfClasses:[NSArray arrayWithObject:[MBProgressHUD class]]];
        ...
        MBBarProgressView *appearance = [MBBarProgressView appearanceWhenContainedInInstancesOfClasses:[NSArray arrayWithObject:[MBProgressHUD class]]];
